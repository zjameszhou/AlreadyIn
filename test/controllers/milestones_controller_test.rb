...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { deadline: @milestone.deadline, description: @milestone.description, name: @milestone.name, project_id: @milestone.project_id, status: @milestone.status } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { deadline: @milestone.deadline, description: @milestone.description, name: @milestone.name, project_id: @milestone.project_id, status: @milestone.status } }
